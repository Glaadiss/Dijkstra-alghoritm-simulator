...
int main()
{
    ...
    for(int i =0; i < 25; i++){
        //std::cout << points[i].id << " - " << points[i].weight << " - " << points[i].related_id  << std::endl;
        //std::cout << points[0].get_direction(3) << std::endl;
    }
    ...
    while (app.isOpen())
    {
        ...
        while( point_id > -1){
            circles[point_id].setFillColor(sf::Color::Green);
